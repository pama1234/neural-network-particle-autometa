...
import static pama1234.processing.al.autometa.particle.util.CellCenter.layer_cell_size;
...
public class Cell extends Entity implements ByteData{
  ...
  public static final float size=3,dist=size;//this two value should always be integer
  ...
  public void display() {
    ...
    parent.layer.ellipse(
      point.pos.x-CellCenter.x1+layer_cell_size,
      point.pos.y-CellCenter.y1+layer_cell_size,
      size,size);
  }
  @Override
  public void pause() {}
